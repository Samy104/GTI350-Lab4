...
public class PlusMinusWithSubtextItemView extends RelativeLayout implements OnClickListener {
	...
	public PlusMinusWithSubtextItemView(Context context, int id, String text, String subtext, int value, int min, int max) {
		super(context);
		...
		inflater.inflate(R.layout.view_item_plus_minus_with_subtext, this, true);
	...
	/**
	 * Sets the subtext (smaller text below main text)
	 *
	 * @param subtext
	 */
