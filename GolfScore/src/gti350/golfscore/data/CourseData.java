...
public class CourseData {
	...
	public static int add(String name, int drawableId) {
	...
	public static int add(String name, int[] pars, int drawableId) {
		Course course = new Course(nextId, name, pars, drawableId);
		courses.add(course);
		nextId++;
		return course.getId();
	}
